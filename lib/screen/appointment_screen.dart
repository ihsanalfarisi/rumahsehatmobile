                      ...
                      itemBuilder: (_, index) => Padding(
                            ...
                            child: Material(
                                ...
                                child: ListTile(
                                  ...
                                  title:
                                      Text(snapshot.data![index].kode),
                                  subtitle: Column(children: [
                                      Text("Dokter: " + snapshot.data![index].dokter.nama),
                                      Text("Waktu awal: " + (DateFormat('d MMM yyy HH:mm:ss').format(snapshot.data![index].waktuAwal).toString())),
                                      
                                      Text("Status: " + (snapshot.data![index].isDone ? "Sudah selesai" : "Belum selesai"))
                                  ],)
